...
sap.ui.define([
	 ...
	 */
	QuickActionItem.prototype.setLabel = function(sLabel) {
		return this.setProperty("label", sLabel).updateContent();
	};

	/**
	 * Calls _updateContent method on QuickActionItem parent object.
	 * Can be {@link sap.m.table.columnmenu.QuickGroup#_updateContent} or
	 * {@link sap.m.table.columnmenu.QuickTotal#_updateContent}.
	 * This is needed to trigger a re-rendering of the <code>ToggleButton</code>
	 * enhanced by a call of its <code>setText</code> method.
	 *
	 * @returns {sap.m.table.columnmenu.QuickActionItem} this
	 * @protected
	 * @since 1.122
	 */
	QuickActionItem.prototype.updateContent = function() {
		this.getParent()?._updateContent?.();
		return this;
	};
